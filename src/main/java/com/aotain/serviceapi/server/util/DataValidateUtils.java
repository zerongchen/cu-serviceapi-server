...
public class DataValidateUtils {
	/**
	 * 手机号的正则
	 *  修改：放开校验，只校验1开头的11位整数
	 */
	//public static final String PHONE_REGEXP = "^((17[0,1,3,5,6,7,8])|(13[0-9])|(14[5,7,9])|(15[^4,\\D])|(18[0-9])|(19[0-9]))\\d{8}$"; //手机号
	public static final String PHONE_REGEXP = "^(1[0-9])\\d{9}$";
	/**
	 * 固定电话的正则
	 */
	 ...
	 * 邮箱的正则
	 */
	public static final String EMAIL_REGEXP = "^[a-zA-Z0-9_\\.\\-]+@[a-zA-Z0-9_\\.\\-]*$";
	...
	public static final String IPV6_STD_REGEXP = "^(^((\\p{XDigit}{1,4}):){7}(\\p{XDigit}{1,4})$)|(^(::((\\p{XDigit}{1,4}):){0,5}(\\p{XDigit}{1,4}))$)|(^((\\p{XDigit}{1,4})(:|::)){0,6}(\\p{XDigit}{1,4})$)$";
	/**
	 * 16进制的ipv6的正则
	 */
	...
	public static final String DATA_DOMAIN_REGEXP = "^(([A-Za-z0-9\u4E00-\u9FA5-~]+)\\.)+([A-Za-z0-9-~\\/])+(\\?{0,1}(([A-Za-z0-9-~]+\\={0,1})([A-Za-z0-9-~]*)\\&{0,1})*)$";
	...
	public static void main(String[] args) {
		...
		System.out.println(validate(DATA_DOMAIN_REGEXP,"s.ww.com"));;
	}
