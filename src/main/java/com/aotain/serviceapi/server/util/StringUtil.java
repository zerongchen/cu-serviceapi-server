...
public class StringUtil {
	...
	public static boolean isMobile(String s) {
		...
		Pattern patern = Pattern.compile("^[0]?((177)|130|131|132|153|156|182|185|186|188|134|135|136|137|138|139|150|151|152|155|157|158|159|133|153|180|181|187|189|183|147)[0-9]{8}$");
	...
	public static boolean isPort(String port) {
		...
		if (isAllDigit(port) && port.length() <= 5 && Integer.parseInt(port) <= 65535 && Integer.parseInt(port) > 0) {
			return true;
		}
		return false;
	}
	...
	public static void main(String[] args) {
		String emt = "1|admin|20140120 14:43";
	...
	public static String getToken(int userId, String userName) {
		Date now = new Date();
		String s = userId + "|" + userName + "|" + DateUtils.formatDateTime("yyyy-MM-dd HH:mm:ss", now);

		return StringUtil.Encode(s);
	}

	public static String join(String val1, String val2, String spchar) {
		if (org.apache.commons.lang3.StringUtils.isBlank(val1)) {
			return val2;
		}
		if (org.apache.commons.lang3.StringUtils.isBlank(val2)) {
			return null;
		}
		return val1.trim() + spchar + val2.trim();
	}
	
	public static List<String> split(String value,String spchar){
		...
		String[] strs = value.split(spchar);
